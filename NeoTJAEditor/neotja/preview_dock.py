...
from PySide6.QtWidgets import (
    QDockWidget, QDoubleSpinBox, QHBoxLayout, QLabel, QPushButton, QVBoxLayout, QWidget,
)

from neotja.audio_engine import AudioEngine, WaveformDecodeWorker
...
class PreviewDock(QDockWidget):
    ...
    def __init__(self, apply_bpm_cb, apply_offset_cb, parent=None):
    ...
    def _build_ui(self):
        ...
        for label, delta in (("-0.1", -0.1), ("-0.01", -0.01), ("+0.01", 0.01), ("+0.1", 0.1)):
    ...
    # ------------------------------------------------------------------
    def refresh_from_content(self, content: str, current_file):
        ...
        self.waveform.set_beat_grid(headers["bpm"], self.spin_offset.value())
        ...
        self.waveform.set_beat_grid(headers["bpm"], headers["offset"])
        ...
        self.status_label.setText("波形を読み込み中...")
    ...
    def _on_offset_value_changed(self, value):
        self.waveform.set_beat_grid(self._editor_bpm, value)
